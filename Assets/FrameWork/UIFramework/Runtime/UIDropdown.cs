...
using TOONIPLAY.CoroutineTween;
...
namespace TOONIPLAY
{
    ...
    public class UIDropdown : Selectable, IPointerClickHandler, ISubmitHandler, ICancelHandler
    {
        ...
        // TMP_Text to be used as a caption for the current value. It's not required, but it's kept here for convenience.
        [SerializeField]
        private TMP_Text m_CaptionText;

        /// <summary>
        /// The TMP_Text component to hold the text of the currently selected option.
        /// </summary>
        ...
        /// <summary>
        /// The TMP_Text component to hold the text of the item.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This is the list of options within the Dropdown. Each option contains TMP_Text and/or image data that you can specify using UI.Dropdown.OptionData before adding to the Dropdown list.
        ...
        /// //Set your own TMP_Text in the Inspector window
        ///
        /// using UnityEngine;
        /// using UnityEngine.UI;
        ///
        ...
        ///             });
        ///
        ///         //Initialise the TMP_Text to say the first value of the Dropdown
        ///         m_Text.text = "First Value : " + m_Dropdown.value;
        ///     }
        ///
        ///     //Ouput the new value of the Dropdown into TMP_Text
        ...
        public GameObject M_DropDown => m_Dropdown;
        ...
        ///     string m_Message;
        ///     //This TMP_Text outputs the current selection to the screen
        ///     public TMP_Text m_Text;
        ...
        ///         //Change the onscreen TMP_Text to reflect the current Dropdown selection
        ...
        {
            if (Application.isPlaying && ((!m_ForceSelect && value == m_Value) || options.Count == 0))
                return;
        ...
        private void SetupTemplate(Canvas rootCanvas)
        {
            ...
            {
                validTemplate = false;
                Debug.LogError("The dropdown template is not valid. The Item TMP_Text must be on the item GameObject or children of it.", template);
            }
        ...
        public void Show()
        {
            ...
            var listScrollRect = m_Dropdown.GetComponent<ScrollRect>();
            var paddingY = dropdownRectTransform.rect.height - listScrollRect.viewport.rect.height;
            ...
            float extraSpace = dropdownRectTransform.rect.height - contentRectTransform.rect.height - paddingY;
            if (extraSpace > 0)
            ...
            if (m_ArrowImage != null)
                m_ArrowImage.transform.localScale = new Vector3(1.0f, -1.0f, 1.0f);
        ...
        public void Hide()
        {
            ...
            if (m_ArrowImage != null)
                m_ArrowImage.transform.localScale = Vector3.one;
        }
